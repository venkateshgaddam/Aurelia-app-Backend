...
WORKDIR /src
COPY ["Hahn.ApplicatonProcess.December2020.WebAPI.csproj", "Hahn.ApplicatonProcess.December2020.WebAPI/"]
RUN dotnet restore "Hahn.ApplicatonProcess.December2020.WebAPI/Hahn.ApplicatonProcess.December2020.WebAPI.csproj"

WORKDIR "/src/Hahn.ApplicatonProcess.December2020.WebAPI"
COPY . .
RUN dotnet build "Hahn.ApplicatonProcess.December2020.WebAPI.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Hahn.ApplicatonProcess.December2020.WebAPI.csproj" \
...
Execute unit tests
```
    cd "Hahn.ApplicatonProcess.December2020.WebAPI/test/Hahn.ApplicatonProcess.December2020.WebAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "Hahn.ApplicatonProcess.December2020.WebAPI/src/Hahn.ApplicatonProcess.December2020.WebAPI"
